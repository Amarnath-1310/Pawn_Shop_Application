          ...
          >
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-gold-200 bg-cream px-3 py-2 pr-10 text-sm text-black shadow-inner focus:border-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-200 sm:px-4 sm:py-2 transition-all duration-300"
